...
class SpawnArbiter(MetaController):
    ...
    def propose_spawn(
        ...
        child_digest = stable_digest("spawned-observer", gate.target_property, node_scope, round(compression.pressure, 6), compression.rank_gap, length=16)
        child_id = f"MC-5.{gate.target_property}.{child_digest}"
